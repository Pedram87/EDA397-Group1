...
public class DatabaseDummy {
    ...
    private static ArrayList<Task> populateTask(){
        ...
        Task task1 = new Task("Create login UI", 6, "a@b.c",
                "g@b.c", "l.g@m.c");

        Task task2 = new Task("Design Database", 8, "mus@bs.cd",
                "g@b.c", "sfs@");

        Task task3 = new Task("Refactor Backend Design", 2, "ddt@bs.cd",
                "gssf@b.c","ksf@gkj.com");

        Task task4 = new Task("Write Tests", 7, "ddt@bs.cd",
               "gssf@b.c", "ksf@gkj.com");

        Task task5 = new Task("Refactor Backend Design", 2, "ddt@bs.cd",
                "gssf@b.c", "ksf@gkj.com");
        taskList.add(task1);
        taskList.add(task2);
        taskList.add(task3);
